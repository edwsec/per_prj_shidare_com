...
const sectionsDirectory = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'sections');
...
function getPostsWithPagination(page = 1, limit = 8) {
...
function getSectionBySlug(slug) {
    try {
        const fullPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(sectionsDirectory, `${slug}.md`);
        const fileContents = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["default"].readFileSync(fullPath, 'utf8');
        // Usar gray-matter para parsear el frontmatter del post
        const matterResult = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gray$2d$matter$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])(fileContents);
        // Usar remark para convertir markdown a HTML
...
function PortfolioPage() {
    const section = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$posts$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getSectionBySlug"])('portfolio');
    if (!section) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4ba5771d._.js.map